...
public class Main {
    ...
    private static Fleet buildFleet() {
        ...
        fleet.add(new Car(
                ...
                2023, "Blue", 4, 2.0, FuelType.GASOLINE, 15.8, 4));

        fleet.add(new Car(
                "5YJ3E1EA7PF123456", "Tesla", "Model 3",
                2024, "Red", 4, 0.0, FuelType.ELECTRIC, 75.0, 4));

        fleet.add(new Car(
                "JTDKARFU2J3061234", "Toyota", "Prius",
                2020, "Silver", 4, 1.8, FuelType.HYBRID, 11.3, 5));

        fleet.add(new Truck(
                "1FT8W3BT5MEC12345", "Ford", "F-350",
                2021, "White", 6, 6.7, FuelType.DIESEL, 40.0, 3500.0));

        fleet.add(new Truck(
                "3C6UR5DL9JG123456", "Ram", "2500",
                2019, "Black", 4, 6.4, FuelType.GASOLINE, 31.0, 1800.0));
    ...
    private static void printGuardRails(Fleet fleet) {
        ...
        System.out.printf(
                "%-23s: %s%n",
                "Fleet size after removal",
                fleet.size());

        try {
            new Car(
                    "2HGCM82633A004353", "Honda", "Civic",
                    2023, "Blue", 4, 2.0,
                    FuelType.ELECTRIC, 15.8, 4);
